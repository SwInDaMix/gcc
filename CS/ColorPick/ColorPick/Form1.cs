...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void _Update(bool do_sort) {
        ...
        private void _lv_kcs_SelectedIndexChanged(object sender, EventArgs e) {
            int dd = _lv_kcs.FocusedItem.Index;
            _tbARGB.Text = _list_colors[dd].ToArgb().ToString("X06");
        }
