...
namespace EtaElectroBike
{
    ...
    {
        private static readonly string SettingRegistryPath = @"Software\Eta\ElectroBike";
        ...
        public static readonly int DefaultDeviceSerialPortBaudRate = 115200;

        private static string _language;
        private static string _device_serial_port;
        private static int? _device_serial_port_baudrate;
...
//        private static Color? _remote_control_back_color;
        ...
        public static int DeviceSerialPortBaudRate { get { if (!_device_serial_port_baudrate.HasValue) _device_serial_port_baudrate = _GetSetting("DeviceSerialPortBaudRate", DefaultDeviceSerialPortBaudRate); return _device_serial_port_baudrate.Value; } set { _SetSetting("DeviceSerialPortBaudRate", value); _device_serial_port_baudrate = value; } }
