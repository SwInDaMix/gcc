...
static int write_to(char const *filename, char const *value)
{
	int fd, ret;
...
static int gpio_sequence(serial_t *serial, char const *s, size_t l)
{
...
static int gpio_bl_entry(serial_t *serial, char const *seq)
{
	char *s;
...
static int gpio_bl_exit(serial_t *serial, char const *seq)
{
	char *s;
...
int init_bl_entry(serial_t *serial, char const *seq)
{
	if (seq)
...
int init_bl_exit(stm32_t *stm, serial_t *serial, char const *seq)
{
	if (seq)
