...
#ifndef _H_FILE_PARSER
#define _H_FILE_PARSER
...
struct parser {
	...
	parser_err_t (*open )(void *storage, char const *filename, char const write);	/* open the file for read|write */
...
static inline char const *parser_errstr(parser_err_t err) {
	switch(err) {
