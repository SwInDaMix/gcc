...
#define HUD_CYCLE_PERIOD_MS 75U
...
#define HUD_BATTERY_PACK_VOLTS_CRITITICAL   ((HUD_BATTERY_CELL_VOLTS_CRTITICAL * BATTERY_CELLS_NUMBER) * 512)

#define HUD_TAILLIGHT_MARKER_PWM 15U
#define HUD_MOTOR_CURRENT_ZERO_TH 2U

#define HUD_ADC_THUMB_CRITICAL_MIN_VALUE 32U
#define HUD_ADC_THUMB_CRITICAL_MAX_VALUE 240U
